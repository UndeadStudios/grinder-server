...
import com.grinder.game.message.impl.SpawnItemMessage
 ...
 * @version 1.0
 */
class SpawnItemMessageDecoder: MessageDecoder<SpawnItemMessage>() {

	override fun decode(packet: Packet) : SpawnItemMessage {
		val reader = PacketReader(packet)
		return SpawnItemMessage()
	}
}

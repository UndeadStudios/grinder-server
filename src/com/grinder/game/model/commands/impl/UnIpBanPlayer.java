...
public class UnIpBanPlayer implements Command {
    ...
    public String getDescription() {
        return "Removes the IP ban from the player's account.";
    }
    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        PunishmentManager.revoke(player, targetName, PunishmentType.IP_BAN);
    }

...
public class MysteryTestCommand implements Command {
	...
	public String getDescription() {
		return "Wipes bank, adds x amount of mystery box opens.";
	}

	// Use ::mysterytest amountOfBoxesToOpen
	// Check bank for the items.
	// Bank gets cleared upon every usage.
	@Override
	public void execute(Player player, String command, String[] parts) {
		Banking.wipe(player);
		player.getPacketSender().sendMessage("Checking " + Integer.parseInt(parts[1]) +" Mystery box rewards!");

...
public class MuddyTest implements Command {
    ...
    public String getDescription() {
        return "Wipes bank and adds x amount of muddy chests.";
    }

	// Use ::muddytest amountOfChestsToOpen
	// Check bank for the items.
	// Bank gets cleared upon every usage.
	@Override
	public void execute(Player player, String command, String[] parts) {
        Banking.wipe(player);
        player.getPacketSender().sendMessage("Checking " + Integer.parseInt(parts[1]) +" Muddy chest rewards!");

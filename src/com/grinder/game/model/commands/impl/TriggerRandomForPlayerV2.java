...
public class TriggerRandomForPlayerV2 implements Command {
    ...
    public void execute(Player player, String command, String[] parts) {
		...
		if (plr.get().getWildernessLevel() <= 0) {
			RandomEvents.triggerPuzzle(plr.get());
		} else {
			RandomEvents.triggerRefreshments(plr.get());
		}

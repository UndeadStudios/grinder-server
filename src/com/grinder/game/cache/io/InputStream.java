package com.grinder.game.cache.io;

import com.grinder.game.cache.io.Stream;
import com.grinder.game.cache.utilities.Miscellaneous;
...
public class InputStream extends Stream {
	...
	public String readStringCp1252NullTerminated() {
		int var1 = this.position; // L: 290

		while (this.buffer[++this.position - 1] != 0) { // L: 291
		}

		int var2 = this.position - var1 - 1; // L: 292
		return var2 == 0 ? "" : decodeStringCp1252(this.buffer, var1, var2); // L: 293 294
	}

...
import com.grinder.game.cache.CacheLibrary;
import com.grinder.game.cache.CacheLibraryMode;
...
import com.grinder.game.cache.store.archive.Archive;
import com.grinder.game.cache.store.archive.ArchiveSector;
import com.grinder.game.cache.utilities.Compression;
import com.grinder.game.cache.utilities.Constants;
import com.grinder.game.cache.utilities.HashGenerator;
import com.grinder.game.cache.utilities.Whirlpool;
...
public class Index extends ReferenceTable {
	 ...
	 */
	private Compression.CompressionType type;
		...
		if (archives != null) {
			...
			for (Archive archive : archives) {
				...
				final byte[] compressed = Compression.compress(uncompressed,
						super.id == 7 ? Compression.CompressionType.NONE : Compression.CompressionType.GZIP, keys, archive.getRevision());
	...
	public void setCompressionType(Compression.CompressionType type) {
		this.type = type;
	}

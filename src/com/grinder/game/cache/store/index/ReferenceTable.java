...
public class ReferenceTable implements Container {
	...
	public Archive addArchive(String name, boolean resetFiles) {
		...
		int hashedName = name == null ? -1 : name.toLowerCase().hashCode();

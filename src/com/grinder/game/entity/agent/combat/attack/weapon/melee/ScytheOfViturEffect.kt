...
object ScytheOfViturEffect {
    ...
    fun postHit(player: Player, target: Agent) {
        ...
        if(ScytheOfVitur.getCharges(weapon) > 0) {
            ScytheOfVitur.decrementCharges(player, weapon)
        } else {

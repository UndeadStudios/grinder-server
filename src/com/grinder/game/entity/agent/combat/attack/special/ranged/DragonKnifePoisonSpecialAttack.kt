 ...
 * @version 1.0
 */
class DragonKnifePoisonSpecialAttack : RangedSpecialAttack(Provider()) {

    override fun special() = SpecialAttackType.DUALITY_P
    ...
    class Provider : RangedSpecialAttackProvider() {
        ...
        override fun getAttackAnimation(type: AttackType?) = Animation(8292, Priority.HIGH)
        override fun fetchAttackSound(type: AttackType?) = Optional.of(Sound(Sounds.RUNE_THROWNAXE_SPECIAL_SOUND))

...
object HolyScytheOfViturEffect {
    ...
    fun postHit(player: Player, target: Agent) {
        ...
        if(HolyScytheOfVitur.getCharges(weapon) > 0) {
            HolyScytheOfVitur.decrementCharges(player, weapon)
        } else {
            player.message("Your Holy scythe of Vitur has run out of charges.")
            return
        }
        //delayBy(1) {

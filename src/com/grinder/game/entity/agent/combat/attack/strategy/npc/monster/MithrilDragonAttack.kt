 ...
 * DragonFire Attack
 */
class MithrilDragonAttack : AttackStrategy<NPC> {

    var attackType: AttackStrategy<Agent> = RangedAttackStrategy.INSTANCE
    ...
    override fun canAttack(actor: NPC, target: Agent): Boolean {
        if (DistanceUtil.isWithinDistance(actor, target, 1) && RandomUtil.RANDOM.nextInt(3) != 0)
            ...
            when(RandomUtil.RANDOM.nextInt(4)) {
                ...
                1,2-> attackType = RangedAttackStrategy.INSTANCE

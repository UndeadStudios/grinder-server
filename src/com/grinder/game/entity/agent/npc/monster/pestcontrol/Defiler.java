...
public class Defiler extends Monster {
    public Defiler(int id, @NotNull Position position) {
        super(id, position);
    }
    ...
    public void process(Position base, PestControlDoorsManager doorsManager, NPC voidKnight) {
        ...
        else if (position.isWithinDistance(base.transform(22, 11, 0), 4) || position.isWithinDistance(base.transform(47, 13, 0), 5)) {

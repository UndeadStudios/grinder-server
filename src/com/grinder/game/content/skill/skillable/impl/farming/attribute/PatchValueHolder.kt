...
import com.grinder.game.content.skill.skillable.impl.farming.FarmingPatch
 ...
 * @since   17/09/2020
 */
class PatchValueHolder(patches: Array<FarmingPatch> = emptyArray())
    : AttributeValueHolderTemplate<Array<FarmingPatch>>(patches) {

    companion object {
        private val gson = GsonBuilder().setPrettyPrinting()
                .excludeFieldsWithoutExposeAnnotation()
                .create()
        private val type = object : TypeToken<Array<FarmingPatch>>() {}.type
    }

...
public enum WeeklyTask implements PlayerTask {
    //combat tasks
    ...
    //fishing tasks
    FISH_RAW_SHARK(500, "Pleased to eat you", "Catch 500 Sharks"),
    ...
    CUTTING_GEMS(500, "Gems Uncut!", "Cut 500 Gems"),
    ...
    POTIONS_CREATOR(250, "Ancient Brews!", "Herblore 250 potions"),
    ...
    CRYSTAL_CHEST(25, "Crystal Shine!", "Open 25 Crystal chests"),
    ...
    SLAYER_KILLS(500, "Slay'em!", "Slay 500 Slayers NPC's on task"),
    ;

    public static final WeeklyTask[] VALUES = values();
    public static final ImmutableSet<WeeklyTask> WEEKLY_TASKS = ImmutableSet.copyOf(VALUES);

    private final int amount;
    private final String title;
    private final String description;

    WeeklyTask(int amount, String title, String description) {
        this.amount = amount;
        this.title = title;

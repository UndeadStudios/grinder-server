...
@Charge(HolyScytheOfVitur.CHARGED, HolyScytheOfVitur.UNCHARGED)
object HolyScytheOfVitur : ItemChargeable {

    val CHARGES = AttributeKey("holy-scythe-charges")

    const val CHARGED = 25736
    const val UNCHARGED = 25738
    ...
    init {
        onSecondInventoryAction(CHARGED, UNCHARGED) {
            if (getItemId() == UNCHARGED) {
                ...
                ChargeablesUtil.createDropDialogue(HolyScytheOfVitur,

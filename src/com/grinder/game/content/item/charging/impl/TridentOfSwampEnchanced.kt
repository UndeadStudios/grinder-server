...
import com.grinder.game.content.item.charging.impl.TridentOfSwampEnchanced.PARTIALLY_CHARGED
import com.grinder.game.content.item.charging.impl.TridentOfSwampEnchanced.UNCHARGED
...
object TridentOfSwampEnchanced : ItemChargeable {

    val CHARGES = AttributeKey("trident-of-swamp-e-charges")

    const val UNCHARGED = 22294
    const val PARTIALLY_CHARGED = 22292

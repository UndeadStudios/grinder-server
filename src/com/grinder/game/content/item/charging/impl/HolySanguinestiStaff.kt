...
@Charge(HolySanguinestiStaff.CHARGED, HolySanguinestiStaff.UNCHARGED)
object HolySanguinestiStaff : ItemChargeable {

    val CHARGES = AttributeKey("holy-sang-charges")

    const val CHARGED = ItemID.HOLY_SANGUINESTI_STAFF
    const val UNCHARGED = ItemID.HOLY_SANGUINESTI_STAFF_UNCHARGED

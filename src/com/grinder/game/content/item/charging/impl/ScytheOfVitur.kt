...
@Charge(ScytheOfVitur.CHARGED, ScytheOfVitur.UNCHARGED)
object ScytheOfVitur : ItemChargeable {

    val CHARGES = AttributeKey("scythe-charges")

    const val CHARGED = 22325
    const val UNCHARGED = 22486

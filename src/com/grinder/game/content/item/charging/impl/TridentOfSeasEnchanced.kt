...
import com.grinder.game.content.item.charging.impl.TridentOfSeasEnchanced.PARTIALLY_CHARGED
import com.grinder.game.content.item.charging.impl.TridentOfSeasEnchanced.UNCHARGED
...
object TridentOfSeasEnchanced : ItemChargeable {

    val CHARGES = AttributeKey("trident-of-seas-e-charges")

    const val UNCHARGED = 22290
    const val PARTIALLY_CHARGED = 22288
    const val MAX_TRIDENT_CHARGES = 20_000

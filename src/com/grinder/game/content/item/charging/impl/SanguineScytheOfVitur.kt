...
@Charge(SanguineScytheOfVitur.CHARGED, SanguineScytheOfVitur.UNCHARGED)
object SanguineScytheOfVitur : ItemChargeable {

    val CHARGES = AttributeKey("sanguine-scythe-charges")

    const val CHARGED = 25739
    const val UNCHARGED = 25741
    ...
    init {
        onSecondInventoryAction(CHARGED, UNCHARGED) {
            if (getItemId() == UNCHARGED) {
                ...
                ChargeablesUtil.createDropDialogue(SanguineScytheOfVitur,

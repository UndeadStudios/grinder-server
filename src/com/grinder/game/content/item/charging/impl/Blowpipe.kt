...
@Charge(Blowpipe.CHARGED, Blowpipe.UNCHARGED)
object Blowpipe : ItemChargeable {

    const val CHARGED = ItemID.TOXIC_BLOWPIPE

    const val UNCHARGED = ItemID.TOXIC_BLOWPIPE_EMPTY_

    val SCALES = AttributeKey("blowpipe-scales")
    val DARTS = AttributeKey("blowpipe-DARTS")
    val DARTS_TYPE = AttributeKey("blowpipe-darts-type")

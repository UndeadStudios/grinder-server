 ...
 */
public class MagicStandardOlmAttack implements OlmAttack {
    @Override
    public void execute(NPC npc, Player target) {

        final ProjectileTemplate temp = ProjectileTemplate.builder(OlmConfiguration.DARK_GREEN_FLYING).setStartHeight(43)
                .setEndHeight(21)
                .setSpeed(55)
                .setDelay(50).build();
        ...
        {
            int damage = 30;
            if (PrayerHandler.hasProtectionPrayer(target, AttackType.MAGIC)) {
                damage *= 0.80;
            }

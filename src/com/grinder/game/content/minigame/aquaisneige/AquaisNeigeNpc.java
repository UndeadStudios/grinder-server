...
public class AquaisNeigeNpc extends Boss implements AttackProvider {

    public AquaisNeigeNpc(int npcId, @NotNull Position position) {
    ...
    public BossAttack generateAttack() {
        if (super.bossAttack == null) {
            super.setBossAttack(new AquaisNeigeAttack(this));
        }

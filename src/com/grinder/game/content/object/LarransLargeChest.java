...
public class LarransLargeChest {
	...
	public enum LarransRewards {
		...
		COINS2(ItemID.COINS, 5_500_000, 25_500_000),
		BLOOD_MONEY(ItemID.BLOOD_MONEY, 10_000, 25_000),
		...
		DRAGON_HAI_HAT(24288, 1, 1),
		DRAGON_HAI_TOP(24291, 1, 1),
		DRAGON_HAI_ROBE(24294, 1, 1)
		;
	 ...
	 */
	public static void openLarransLargeChest(final Player player) {
        ...
        int amount = Misc.randomInclusive(reward.getMinimumAmount(), reward.getMaximumAmount() == 1 ? reward.getMaximumAmount() : reward.getMaximumAmount() * 2);
        // Logging

...
public final class PacketBuilder {
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder put(int value, DataTransformation type) {
        switch (type) {
            case ADD:
                value += 128;
                break;
    ...
    public PacketBuilder put(int value) {
        put(value, DataTransformation.NONE);
        return this;
    }
     ...
     */
    public PacketBuilder putShort(int value, DataTransformation type, DataOrder order) {
        switch (order) {
            case BIG:
                put(value >> 8);
                put(value, type);
    ...
    public PacketBuilder putShort(int value) {
        putShort(value, DataTransformation.NONE, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putShort(int value, DataTransformation type) {
        putShort(value, type, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putShort(int value, DataOrder order) {
        putShort(value, DataTransformation.NONE, order);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putInt(int value, DataTransformation type, DataOrder order) {
        switch (order) {
            case BIG:
                put(value >> 24);
                put(value >> 16);
    ...
    public PacketBuilder putInt(int value) {
        putInt(value, DataTransformation.NONE, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putInt(int value, DataTransformation type) {
        putInt(value, type, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putInt(int value, DataOrder order) {
        putInt(value, DataTransformation.NONE, order);
        return this;
    }
     ...
     */
    public PacketBuilder putLong(long value, DataTransformation type, DataOrder order) {
        switch (order) {
            case BIG:
                put((int) (value >> 56));
                put((int) (value >> 48));
    ...
    public PacketBuilder putLong(long value) {
        putLong(value, DataTransformation.NONE, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putLong(long value, DataTransformation type) {
        putLong(value, type, DataOrder.BIG);
        return this;
    }
     ...
     * @return an instance of this message builder.
     */
    public PacketBuilder putLong(long value, DataOrder order) {
        putLong(value, DataTransformation.NONE, order);
        return this;
    }

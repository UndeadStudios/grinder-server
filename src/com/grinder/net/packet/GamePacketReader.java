...
/**
 * A utility class for reading {@link Packet}s.
 *
 * @author Graham
 */
public final class GamePacketReader {
	 ...
	 */
	public GamePacketReader(Packet packet) {
	...
	public int getUnsignedSmart()
	{
		...
		return peek < 128
				...
				: buffer.readUnsignedShort() - 0x8000;
	}
	...
	public String readOsString(){
		if(buffer.isReadable()){
			...
			return new String(data, 0, size-1);
		} else
			return "";
	}
